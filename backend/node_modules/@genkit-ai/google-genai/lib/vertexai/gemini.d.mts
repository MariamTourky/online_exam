...
import { ClientOptions, VertexPluginOptions, Model } from './types.mjs';
...
declare const GeminiConfigSchema: z.ZodObject<{
    ...
    payGo: z.ZodOptional<z.ZodEnum<["priority", "priority-only", "flex", "flex-only"]>>;
...
declare const GeminiImageConfigSchema: z.ZodObject<{
    ...
    imageConfig: z.ZodOptional<z.ZodObject<{
        ...
        imageSize: z.ZodOptional<z.ZodEnum<["512", "1K", "2K", "4K"]>>;
    }, "passthrough", z.ZodTypeAny, z.objectOutputType<{
        aspectRatio: z.ZodOptional<z.ZodEnum<["1:1", "2:3", "3:2", "3:4", "4:3", "4:5", "5:4", "9:16", "16:9", "21:9"]>>;
        imageSize: z.ZodOptional<z.ZodEnum<["512", "1K", "2K", "4K"]>>;
    }, z.ZodTypeAny, "passthrough">, z.objectInputType<{
...
declare const KNOWN_GEMINI_MODELS: {
    readonly 'gemini-3.1-flash-lite-preview': ModelReference<ConfigSchemaType>;
    readonly 'gemini-3.1-pro-preview': ModelReference<ConfigSchemaType>;
    readonly 'gemini-3-flash-preview': ModelReference<ConfigSchemaType>;
...
declare function listKnownModels(clientOptions: ClientOptions, pluginOptions?: VertexPluginOptions): ModelAction[];
/**
