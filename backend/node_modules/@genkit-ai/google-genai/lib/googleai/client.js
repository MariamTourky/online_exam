...
async function cancelInteraction(apiKey, interactionId, clientOptions) {
  ...
  try {
    ...
    if (e instanceof import_genkit.GenkitError && e.status === "CANCELLED") {
      return {
        id: interactionId,
        status: "cancelled"
      };
