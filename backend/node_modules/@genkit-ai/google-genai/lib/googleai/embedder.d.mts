import { z, EmbedderReference, EmbedderAction, ActionMetadata } from 'genkit';
...
declare const EmbeddingConfigSchema: z.ZodObject<{
     ...
     **/
    taskType: z.ZodOptional<z.ZodEnum<["RETRIEVAL_DOCUMENT", "RETRIEVAL_QUERY", "SEMANTIC_SIMILARITY", "CLASSIFICATION", "CLUSTERING", "CODE_RETRIEVAL_QUERY", "QUESTION_ANSWERING", "FACT_VERIFICATION"]>>;
...
declare const KNOWN_MODELS: {
    readonly 'gemini-embedding-2-preview': EmbedderReference<z.ZodObject<{
        /** Override the API key provided at plugin initialization. */
        apiKey: z.ZodOptional<z.ZodString>;
        /**
         * The `task_type` parameter is defined as the intended downstream application to help the model
    ...
    readonly 'gemini-embedding-2': EmbedderReference<z.ZodObject<{
        /** Override the API key provided at plugin initialization. */
        apiKey: z.ZodOptional<z.ZodString>;
        /**
         * The `task_type` parameter is defined as the intended downstream application to help the model
...
type EmbedderModelName = `gemini-embedding-${string}`;
declare function isEmbedderName(value: string): value is EmbedderModelName;
...
declare function listKnownModels(options?: GoogleAIPluginOptions): EmbedderAction[];
...
export { type EmbedderModelName, type EmbeddingConfig, EmbeddingConfigSchema, type EmbeddingConfigSchemaType, type KnownModels, TEST_ONLY, defineEmbedder, isEmbedderName, listActions, listKnownModels, model };
