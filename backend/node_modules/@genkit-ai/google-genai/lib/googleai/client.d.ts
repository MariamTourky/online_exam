import { ClientOptions, EmbedContentRequest, EmbedContentResponse, Model, VeoOperation, VeoPredictRequest } from './types.js';
import { GeminiInteraction, CreateInteractionRequest } from './interaction-types.js';
