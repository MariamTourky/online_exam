...
exports.stopTelemetryApi = exports.startTelemetryServer = exports.TraceQuerySchema = exports.LocalFileTraceStore = exports.LocalFileLogStore = void 0;
...
const otlp_js_1 = require("./utils/otlp.js");
var file_log_store_js_1 = require("./file-log-store.js");
Object.defineProperty(exports, "LocalFileLogStore", { enumerable: true, get: function () { return file_log_store_js_1.LocalFileLogStore; } });
...
async function startTelemetryServer(params) {
    ...
    api.get('/api/logs', async (request, response, next) => {
        try {
            ...
            response.json(await params.logStore.list({
    ...
    api.post([
        ...
        try {
            ...
            const traces = (0, otlp_js_1.traceDataFromOtlp)(request.body);
            ...
            if (request.body.resourceLogs?.length) {
                const logs = (0, otlp_js_1.logDataFromOtlp)(request.body);
                if (logs.length > 0) {
