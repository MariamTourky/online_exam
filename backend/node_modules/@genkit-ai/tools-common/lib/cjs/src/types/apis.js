...
exports.ValidateDataResponseSchema = exports.ErrorDetailSchema = exports.ValidateDataRequestSchema = exports.RunNewEvaluationRequestSchema = exports.UpdateDatasetRequestSchema = exports.CreateDatasetRequestSchema = exports.DeleteEvalRunRequestSchema = exports.GetEvalRunRequestSchema = exports.ListEvalKeysResponseSchema = exports.ListEvalKeysRequestSchema = exports.PageViewSchema = exports.CreatePromptRequestSchema = exports.CancelActionRequestSchema = exports.RunActionRequestSchema = exports.ListValuesRequestSchema = exports.ListActionsRequestSchema = exports.StreamTraceRequestSchema = exports.GetTraceRequestSchema = exports.ListLogsResponseSchema = exports.ListLogsRequestSchema = exports.LogQueryFilterSchema = exports.ListTracesResponseSchema = exports.ListTracesRequestSchema = exports.TraceQueryFilterSchema = void 0;
...
const PrimitiveSchema = zod_1.z.union([zod_1.z.string(), zod_1.z.number()]);
const FilterValueSchema = zod_1.z.union([PrimitiveSchema, zod_1.z.array(PrimitiveSchema)]);
exports.TraceQueryFilterSchema = zod_1.z.object({
    eq: zod_1.z.record(zod_1.z.string(), FilterValueSchema).optional(),
    neq: zod_1.z.record(zod_1.z.string(), FilterValueSchema).optional(),
    gt: zod_1.z.record(zod_1.z.string(), zod_1.z.number()).optional(),
    gte: zod_1.z.record(zod_1.z.string(), zod_1.z.number()).optional(),
    lt: zod_1.z.record(zod_1.z.string(), zod_1.z.number()).optional(),
    lte: zod_1.z.record(zod_1.z.string(), zod_1.z.number()).optional(),
    contains: zod_1.z.record(zod_1.z.string(), FilterValueSchema).optional(),
});
...
exports.LogQueryFilterSchema = zod_1.z.object({
    traceId: zod_1.z.string().optional(),
    spanId: zod_1.z.string().optional(),
});
exports.ListLogsRequestSchema = zod_1.z.object({
    limit: zod_1.z.number().optional(),
    continuationToken: zod_1.z.string().optional(),
    filter: exports.LogQueryFilterSchema.optional(),
});
exports.ListLogsResponseSchema = zod_1.z.object({
    logs: zod_1.z.array(log_1.LogRecordSchema),
    continuationToken: zod_1.z.string().optional(),
});
...
exports.ListActionsRequestSchema = zod_1.z
    ...
    .optional();
exports.ListValuesRequestSchema = zod_1.z.object({
    runtimeId: zod_1.z
        .string()
        .optional()
        .describe('ID of the Genkit runtime to run the action on. Typically $pid-$port.'),
    type: zod_1.z
        .string()
        .describe("The type of values to fetch. Currently only supports 'defaultModel'"),
});
...
exports.CreatePromptRequestSchema = zod_1.z.object({
    ...
    use: zod_1.z.array(middleware_1.MiddlewareRefSchema).optional(),
});
