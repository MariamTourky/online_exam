import { z, Operation, GenerateResponseData, ActionMetadata } from 'genkit';
import { ModelReference, GenerateRequest, BackgroundModelAction } from 'genkit/model';
import { VeoParameters, VeoOperation, GoogleAIPluginOptions, Model } from './types.mjs';
...
declare const KNOWN_MODELS: {
    readonly 'veo-3.1-lite-generate-preview': ModelReference<z.ZodObject<{
        negativePrompt: z.ZodOptional<z.ZodString>;
        aspectRatio: z.ZodOptional<z.ZodEnum<["9:16", "16:9"]>>;
        personGeneration: z.ZodOptional<z.ZodEnum<["dont_allow", "allow_adult", "allow_all"]>>;
        durationSeconds: z.ZodOptional<z.ZodNumber>;
