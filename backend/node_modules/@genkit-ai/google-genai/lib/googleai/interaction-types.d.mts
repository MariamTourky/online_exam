...
import { FunctionDeclaration, ToolConfig } from '../common/types.mjs';
 ...
 */
declare interface InteractionFunctionTool extends FunctionDeclaration {
    type: 'function';
}
/**
 ...
 */
declare interface InteractionGoogleSearchTool {
    type: 'google_search';
}
/**
 ...
 */
declare interface InteractionMcpServerTool {
    type: 'mcp_server';
    name?: string;
    url?: string;
 ...
 * A tool that can be used by the model.
 */
declare type InteractionTool = InteractionFunctionTool | InteractionGoogleSearchTool | InteractionCodeExecutionTool | InteractionUrlContextTool | InteractionFileSearchTool | InteractionMcpServerTool;
/**
 ...
 */
declare type MediaResolution = 'low' | 'medium' | 'high' | 'ultra_high';
/**
 ...
 */
type Content = TextContent | ImageContent | AudioContent | DocumentContent | VideoContent | ThoughtContent | FunctionCallContent | FunctionResultContent;
...
type Step = ModelOutputStep | UserInputStep | Content | GoogleSearchCallStep | GoogleSearchResultStep | CodeExecutionCallStep | CodeExecutionResultStep;
/**
 ...
 */
declare interface ModalityTokens {
 ...
 */
declare interface ModelGenerationConfig {
 ...
 */
type InteractionsAgentConfig = DynamicAgentConfig | DeepResearchAgentConfig;
/**
 * Indicates the model should return text, images, or audio.
 */
declare type ResponseModality = 'text' | 'image' | 'audio';
/**
 * Parameters for creating interactions.
 */
declare interface CreateInteractionRequest {
 ...
 */
declare interface GeminiInteraction {
...
export type { AudioContent, CodeExecutionCallStep, CodeExecutionResultStep, Content, CreateInteractionRequest, DeepResearchAgentConfig, DocumentContent, DynamicAgentConfig, FunctionCallContent, FunctionResultContent, GeminiInteraction, GoogleSearchCallStep, GoogleSearchResultStep, ImageConfig, ImageContent, InteractionCodeExecutionTool, InteractionFileSearchTool, InteractionFunctionTool, InteractionGoogleSearchTool, InteractionMcpServerTool, InteractionTool, InteractionUrlContextTool, InteractionsAgentConfig, MediaResolution, ModalityTokens, ModelGenerationConfig, ModelOutputStep, ResponseModality, SpeechConfig, Step, TextContent, ThoughtContent, Turn, Usage, UserInputStep, VideoContent };
