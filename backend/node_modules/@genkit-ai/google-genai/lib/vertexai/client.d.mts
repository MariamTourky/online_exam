import { CreateInteractionRequest, GeminiInteraction } from './interaction-types.mjs';
import { ClientOptions, EmbedContentRequest, EmbedContentResponse, Model, LyriaPredictRequest, LyriaPredictResponse, VeoOperationRequest, VeoOperation, VeoPredictRequest } from './types.mjs';
...
declare function createInteraction(createInteractionRequest: CreateInteractionRequest, clientOptions: ClientOptions): Promise<GeminiInteraction>;
...
export { TEST_ONLY, createInteraction, embedContent, generateContent, generateContentStream, getVertexAIUrl, imagenPredict, listModels, lyriaPredict, veoCheckOperation, veoPredict };
