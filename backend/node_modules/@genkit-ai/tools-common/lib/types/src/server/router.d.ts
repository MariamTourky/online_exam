...
export declare const TOOLS_SERVER_ROUTER: (manager: BaseRuntimeManager) => import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
    ctx: object;
    meta: object;
    ...
    listActions: import("@trpc/server").BuildProcedure<"query", {
        ...
        metadata?: Record<string, string | number | bigint | boolean | z.objectOutputType<{}, z.ZodTypeAny, "passthrough"> | (string | number | bigint | boolean | z.objectOutputType<{}, z.ZodTypeAny, "passthrough">)[]> | null | undefined;
    }>>;
    listValues: import("@trpc/server").BuildProcedure<"query", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
    ...
    listLogs: import("@trpc/server").BuildProcedure<"query", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
