import { ClientOptions, EmbedContentRequest, EmbedContentResponse, Model, VeoOperation, VeoPredictRequest } from './types.mjs';
import { GeminiInteraction, CreateInteractionRequest } from './interaction-types.mjs';
 ...
 */
declare function createInteraction(apiKey: string | undefined, createInteractionRequest: CreateInteractionRequest, clientOptions?: ClientOptions): Promise<GeminiInteraction>;
/**
 ...
 * @returns A promise that resolves to the interaction response.
 */
declare function getInteraction(apiKey: string | undefined, interactionId: string, clientOptions?: ClientOptions): Promise<GeminiInteraction>;
/**
 ...
 * @returns A promise that resolves to the interaction response.
 */
declare function cancelInteraction(apiKey: string | undefined, interactionId: string, clientOptions?: ClientOptions): Promise<GeminiInteraction>;
/**
 ...
 */
declare function getHeaders(apiKey?: string, clientOptions?: ClientOptions, isInteraction?: boolean): HeadersInit;
/**
...
export { TEST_ONLY, cancelInteraction, createInteraction, embedContent, generateContent, generateContentStream, getGoogleAIUrl, getInteraction, imagenPredict, listModels, veoCheckOperation, veoPredict };
