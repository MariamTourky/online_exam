...
export function startServer(manager, port) {
    ...
    app.post('/api/streamAction', bodyParser.json({ limit: MAX_PAYLOAD_SIZE }), async (req, res) => {
        ...
        let capturedTraceId;
        try {
            const onTraceIdCallback = (traceId) => {
    ...
    app.post('/api/sendBidiInput', bodyParser.json({ limit: MAX_PAYLOAD_SIZE }), (req, res) => {
