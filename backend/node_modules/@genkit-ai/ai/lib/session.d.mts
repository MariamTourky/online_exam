...
import { b as GenerateOptions, E as ExecutablePrompt, c as GenerateStreamOptions, d as GenerateStreamResponse } from './generate-D3ZU1vYD.mjs';
import { MessageData, GenerationCommonConfigSchema } from './model-types.mjs';
...
declare class Session<S = any> {
     ...
     */
    updateState(data: Partial<S>): Promise<void>;
    /**
...
declare const SESSION_ID_ATTR = "genkit:sessionId";
declare const THREAD_NAME_ATTR = "genkit:threadName";
...
export { type BaseGenerateOptions, Chat as C, MAIN_THREAD as M, type PromptRenderOptions as P, SESSION_ID_ATTR as S, Session, type SessionData, SessionError, type SessionOptions, type SessionStore, THREAD_NAME_ATTR as T, type ChatGenerateOptions as a, type ChatOptions as b, getCurrentSession, inMemorySessionStore, runWithSession };
